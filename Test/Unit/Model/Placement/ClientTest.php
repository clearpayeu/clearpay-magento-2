...
namespace Clearpay\Clearpay\Test\Unit\Model\Placement;

use Clearpay\Clearpay\Model\Placement\Client;
...
class ClientTest extends TestCase
{
    ...
    public function testExecuteReturnsEmptyArrayOnErrorResponse(): void
    {
        ...
        $this->loggerMock->expects($this->once())
            ->method('critical')
            ->with("Clearpay: Error fetching placement data for mpid: {$mpid}");
    ...
    public function testExecuteHandlesExceptionDuringApiCall(): void
    {
        ...
        $this->loggerMock->expects($this->once())
            ->method('critical')
            ->with(
                $this->stringContains("Clearpay: Error fetching placement data for mpid: {$mpid}. {$exceptionMessage}"),
                $this->anything()
            );
