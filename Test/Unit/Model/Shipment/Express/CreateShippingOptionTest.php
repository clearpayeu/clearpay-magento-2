...
namespace Clearpay\Clearpay\Test\Unit\Model\Shipment\Express;

class CreateShippingOptionTest extends \PHPUnit\Framework\TestCase
{
    private \Clearpay\Clearpay\Model\Shipment\Express\CreateShippingOption $createShippingOption;
    /**
    ...
    private $quote;
    /**
     * @var \Clearpay\Clearpay\Model\CBT\CheckCBTCurrencyAvailabilityInterface
     */
    private $checkCBTCurrencyAvailability;

    protected function setUp(): void
    {
        $this->config = $this->createMock(\Clearpay\Clearpay\Model\Config::class);
        ...
        $this->checkCBTCurrencyAvailability = $this->createMock(
            \Clearpay\Clearpay\Model\CBT\CheckCBTCurrencyAvailabilityInterface::class
        );
        ...
        $this->createShippingOption = new \Clearpay\Clearpay\Model\Shipment\Express\CreateShippingOption(
            $this->config,
