...
namespace Clearpay\Clearpay\Test\Unit\Model\Payment\AmountProcessor;

use Clearpay\Clearpay\Model\Payment\AmountProcessor\CreditMemo as CreditMemoAmountProcessor;
    ...
    private function initPaymentObject(): void
    {
        ...
        $this->payment->expects($this->any())->method("getAdditionalInformation")
            ...
            ->willReturn([
                ...
                => \Clearpay\Clearpay\Model\PaymentStateInterface::AUTH_APPROVED
            ]);
    }
