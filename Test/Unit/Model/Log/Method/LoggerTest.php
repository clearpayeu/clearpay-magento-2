...
namespace Clearpay\Clearpay\Test\Unit\Model\Log\Method;

use Magento\Payment\Model\Method\Logger;

class LoggerTest extends \PHPUnit\Framework\TestCase
{
    protected \Clearpay\Clearpay\Model\Log\Method\Logger $logger;
    ...
    protected function setUp(): void
    {
        $this->monolog = $this->getMockBuilder(\Magento\Framework\Logger\Monolog::class)
            ...
            ->getMock();
        $this->logger = new \Clearpay\Clearpay\Model\Log\Method\Logger($this->monolog);
    }
    ...
    private function provideReadData(): array
    {
        ...
        $data = [
            ...
            'client' => 'Clearpay\\Clearpay\\Gateway\\Http\\Client\\Client',
            'response' => [
                'id' => '100101665793',
