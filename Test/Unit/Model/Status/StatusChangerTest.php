...
class StatusChangerTest extends \PHPUnit\Framework\TestCase
{
    ...
    private $expiryDate;
    /**
     * @var \Clearpay\Clearpay\Model\Order\CreditMemo\CreditMemoInitiator|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    /**
     * @var \Clearpay\Clearpay\Model\Order\CreditMemo\OrderUpdater|\PHPUnit\Framework\MockObject\MockObject
     */
    private $orderUpdater;
    /**
     * @var \Clearpay\Clearpay\Model\Order\CreditMemo\PaymentUpdater|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    public function setUp(): void
    {
        $this->expiryDate = $this->createMock(
            \Clearpay\Clearpay\Model\Order\Payment\Auth\ExpiryDate::class
        );
        $this->creditmemoInitiator = $this->createMock(
            \Clearpay\Clearpay\Model\Order\CreditMemo\CreditMemoInitiator::class
        );
        $this->creditmemoManager = $this->createMock(
            \Magento\Sales\Api\CreditmemoManagementInterface::class
        );
        $this->orderUpdater = $this->createMock(
            \Clearpay\Clearpay\Model\Order\CreditMemo\OrderUpdater::class
        );
        $this->paymentUpdater = $this->createMock(
            \Clearpay\Clearpay\Model\Order\CreditMemo\PaymentUpdater::class
        );
        $this->creditMemoProcessor = new  \Clearpay\Clearpay\Model\Order\CreditMemo\CreditMemoProcessor(
            $this->expiryDate,
    ...
    public function dataForProcessOrder():array
    {
        return [
            ...
            [
                ...
                [
                    AdditionalInformationInterface::CLEARPAY_PAYMENT_STATE => 'NOT RIGHT'
                ]
            ],
            [
                true,
