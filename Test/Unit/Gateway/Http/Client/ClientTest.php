...
namespace Clearpay\Clearpay\Test\Unit\Gateway\Http\Client;
...
class ClientTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->client = new \Clearpay\Clearpay\Gateway\Http\Client\Client(
            $this->httpClientMock,
            $serializer,
            $loggerMock,
            $debugLoggerMock,
    ...
    public function testHttpClientBody($bodyFromTransfer, $expectedBodyForHttpClient): void
    {
        ...
        $transferMock->method('getMethod')
            ->willReturn(\Clearpay\Clearpay\Gateway\Http\TransferFactory::METHOD_POST);
    ...
    public function testHttpClientGetMethod(): void
    {
        ...
        $transferMock->method('getMethod')
            ->willReturn(\Clearpay\Clearpay\Gateway\Http\TransferFactory::METHOD_GET);
        $this->httpClientMock->expects($this->once())
            ->method('get');
