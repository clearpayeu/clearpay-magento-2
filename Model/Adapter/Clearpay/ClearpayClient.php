...
class ClearpayClient
{
     ...
     *
     * Will always be set to Basic for Clearpay API
     *
     * @var array|null
     */
    protected $auth;
     ...
     * @return ClearpayResponse         Formatted Clearpay Response Object
     */
     ...
     *
     * @param string $method            The HTTP Verb used (GET, POST)
     * @param ClearpayResponse $object  Clearpay Response object
     * @return ClearpayResponse         Formatted Clearpay Response Object
     * @throws Exception
     */
    protected function execute($method, $object)
    {
        ...
        try {
            ...
            if (empty($curl_response)) {
                throw new \Exception("Invalid Response from Clearpay API");
            }
            else {
            ...
            throw new \Exception("Something went wrong in Clearpay API Connection");
