...
class OrderItemProvider
{
    ...
    public function provide(Item $orderItem): \Clearpay\Clearpay\Model\Order\OrderItemInterface
    {
        ...
        $orderItem = $this->orderItemFactory->create()
            ->setClearpayRefundedQty($result['refunded_qty'])
            ->setClearpayVoidedQty($result['voided_qty']);
