...
namespace Clearpay\Clearpay\Model\Placement\Service;

use Magento\Framework\Exception\LocalizedException;

class GetPlacementData
{
    private \Clearpay\Clearpay\Model\Placement\Client $client;

    public function __construct(
        \Clearpay\Clearpay\Model\Placement\Client $client
    ) {
        $this->client = $client;
    }
