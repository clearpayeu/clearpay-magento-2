...
class Response extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Clearpay\Clearpay\Model\Adapter\V1\ClearpayOrderDirectCapture $directCapture,
        \Clearpay\Clearpay\Model\Adapter\V1\ClearpayOrderTokenCheck $tokenCheck,
                ...
                case \Clearpay\Clearpay\Model\Response::RESPONSE_STATUS_SUCCESS:
                    ...
                    switch ($response['status']) {
                        ...
                        case \Clearpay\Clearpay\Model\Response::RESPONSE_STATUS_DECLINED:
                            ...
                            break;
                        // case \Clearpay\Clearpay\Model\Response::RESPONSE_STATUS_PENDING:
                        //     $payment->setTransactionId($payment->getClearpayOrderId())
                        //         ->setIsTransactionPending(true);
                        //     break;
                        default:
                            // $this->messageManager->addError(__('There is a problem with your Clearpay payment. Please select an alternative payment method.'));
